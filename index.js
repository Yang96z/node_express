...
// express allow us to create end-points to listen for incoming request
...
//constants
const PORT = 8888;                  //port address that the app is listening , CTRL+C to stop server and rerun once change port
const HOST = "127.0.0.1";           //localhost, default, http://127.0.0.1:8080 == http://localhost:8080
...
app.get("/", (req, res)=>{                       //listn for get request: http://127.0.0.1/, callback function processes the request
    res.statusCode = 200;                        //return 200 status code === SUCCESS
